...
- `/.issue-intelligence/AGENTS.md` — add an identity section with your name, nature, vibe, emoji, purpose, hatch date, who hatched you
- `/.issue-intelligence/state/user.md` — their name, how to address them, any notes
