...
2. Optionally delete `.issue-intelligence/ISSUE-INTELLIGENCE-ENABLED.md` — this is the fail-safe disable (see [Disable](disable.md))
3. Keep `.issue-intelligence/state/` for historical sessions

The session files in `.issue-intelligence/state/sessions/` are plain JSONL files and remain readable without Issue Intelligence installed.
