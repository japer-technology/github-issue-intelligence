...
- Create `.issue-intelligence/AGENTS.md` — the agent identity file (if not already present)
...
- **Sentinel file missing** — ensure `.issue-intelligence/ISSUE-INTELLIGENCE-ENABLED.md` exists (see [Enable](enable.md))
